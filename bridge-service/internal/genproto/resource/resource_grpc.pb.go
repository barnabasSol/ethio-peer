...
const (
	PostsService_GetPosts_FullMethodName = "/PostsService/GetPosts"
)
...
func (c *postsServiceClient) GetPosts(ctx context.Context, in *PostsRequest, opts ...grpc.CallOption) (*PostsReply, error) {
...
func (UnimplementedPostsServiceServer) GetPosts(context.Context, *PostsRequest) (*PostsReply, error) {
...
func _PostsService_GetPosts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PostsServiceServer).GetPosts(ctx, req.(*PostsRequest))
	}
